  ...
  <section class="banner">
    <div class="escuro">
            ...
            <v-card class="elevation-12" width="400px" min-width="250px">
              <v-toolbar
                color="black darken-4 centralizar"
                dark
                flat
              >
    ...
    >
      ...
      <v-card>
        <v-card-title
          class="headline black darken-4 white--text"
          primary-title
        >
          Problemas...
        </v-card-title>
    ...
    <v-alert  transition="scale-transition" color="white--text black" :value="!!alerta">{{ alerta}}</v-alert>
                </v-form>
              </v-card-text>
              <v-card-actions>
                <div class="flex-grow-1"></div>
                <div @click="voltar">
                  <v-btn class="mr-3 mb-2 black--text" color="white" >Voltar</v-btn>
                </div>
                
                <div @click="acessar">
                  <v-btn class="mr-3 mb-2 white--text" color="black darken-4" >Entrar</v-btn>
                </div>
...
<!-- Cadastro -->
            ...
            <v-card class="elevation-12 espaco" width="400px" min-width="250px">
              ...
              <v-card-actions class="d-flex flex-wrap quebra">
                <div class="flex-grow-1"></div>
                <!-- <v-switch v-model="valid" class="ma-4" label="Valid" readonly></v-switch> -->
                <v-btn
                  color="white"
                  class="mr-3 mb-2 black--text central"
                  @click="reset"
                >
                  Apagar 
                </v-btn>
